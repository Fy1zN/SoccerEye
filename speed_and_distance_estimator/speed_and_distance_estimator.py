...
class SpeedAndDistance_Estimator:
    ...
    def add_speed_and_distance_to_tracks(
        ...
        for object_name, object_tracks in tracks.items():
            ...
            for frame_num in range(
                ...
                for track_id, _ in (
                    object_tracks[frame_num].items()
                ):

                    if (
                        track_id
                        not in object_tracks[last_frame]
                    ):
                        continue
    ...
    def draw_speed_and_distance(
        ...
        for frame_num, frame in enumerate(
            ...
            for object_name, object_tracks in (
                tracks.items()
            ):
                ...
                for _, track_info in (
                    ...
                    speed = track_info.get(
                        "speed"
                    )

                    distance = track_info.get(
                        "distance"
                    )
